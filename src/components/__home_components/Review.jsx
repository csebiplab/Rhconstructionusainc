    ...
    return (
       <div className="section-bg">
        <div className="custom-container">
         <div className="lg:py-16 py-6 lg:px-[61px]">
          ...
          />
                <div className="text-start md:p-2 lg:p-3">
                  ...
                  <h6 className="font-semibold lg:text-sm md:text-xs py-1">Lisa Silva</h6>
      <p className="text-secondary lg:text-sm md:text-xs">North York</p>
                </div>
              </div>
              <div className="w-full card-sd rounded-md bg-white">
              <Image
          ...
          />
                <div className="text-start md:p-2 lg:p-3">
                  ...
                  <h6 className="font-semibold py-1 lg:text-sm md:text-xs">Lisa Silva</h6>
      <p className="text-secondary lg:text-sm md:text-xs">North York</p>
                </div>
              </div>
              <div className="w-full card-sd rounded-md bg-white">
