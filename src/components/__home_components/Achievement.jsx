  ...
  return (
    <>
     ...
     <div className="flex gap-2 xs:mt-5 md:mt-3 lg:mt-4">
        <div className="md:w-[180px] md:h-[147.98px] my-class rounded-[8px] pt-[31.25px] text-center">
        ...
        <div className="lg:w-[604px] lg:h-[147.98px] my-class rounded-[8px] px-[22.5px] md:pt-2 xs:pt-5">
