...
const Achievement = () => {
  return (
    <>
      ...
      <div className="flex flex-wrap gap-2 xs:mt-5 md:mt-3 lg:mt-4">
          <div className="md:w-[180px] md:h-[147.98px] md:flex-0 flex-1 my-class rounded-[8px] pt-[31.25px] text-center">
