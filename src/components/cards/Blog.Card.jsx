...
export function BlogCard({ data }) {
  return (
    ...
    <Card className="overflow-hidden rounded-md hover:shadow-2xl shadow-black/20 duration-150">
      <CardHeader
        floated={false}
        shadow={false}
        color="transparent"
      ...
      >
        <img src={data?.image} alt="Blog image" className="h-64 w-full object-cover object-center" />
      </CardHeader>
      <CardBody>
        <div className="flex gap-2 flex-wrap items-center mb-2">
          ...
          <span className="inline-flex font-medium gap-1 py-1 px-2 justify-center items-center">
            ...
            <span className="text-[10px]">{`${data.comments||'No'} comments`}</span>
          </span>
        </div>
