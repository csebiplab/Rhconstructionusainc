        ...
        <div className=" grid md:grid-cols-7 grid-cols-1 md:gap-[30px]">
          ...
          <div className="md:col-span-4 pt-3 md:pt-0">
            <div className="flex flex-col justify-center items-center md:items-start ">
              ...
              <div>
                <h5 className="text-3xl lg:text-[32px] xl:text-[34px] 2xl:text-4xl 3xl:text-[38px] 4xl:text-[40px] 5xl:text-[42px] leading-normal font-bold text-black md:text-start text-center pb-2">
